...
FOV_WARN = False
def render(viewpoint_cameras, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, mask=None, normalize_grad2D=False, low_pass=0.3, grad_sep=False, time_check=False):
    """
    Render the scene. 
