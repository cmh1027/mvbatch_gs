...
python train.py --source_path data/mipnerf360/${SCENE} --config configs/${SCENE}.json -m output/${SCENE}/aux_thres${THRES} --batch_type none --aux_densify --aux_densify_threshold ${THRES}
